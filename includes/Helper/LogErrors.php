...
class LogErrors {
	...
	public static function writeLog( $message, $type_log = 'error', $name = 'log' ) {
		...
		$folder = YAY_SMTP_SENDINBLUE_PLUGIN_PATH . '/includes/Logs';
	...
	public static function clearLog() {
		$file = YAY_SMTP_SENDINBLUE_PLUGIN_PATH . 'includes/Logs/log.txt';
		if ( file_exists( $file ) ) {
	...
	public static function clearErr() {
		update_option( YAY_SMTP_SENDINBLUE_PREFIX . '_debug', array() );
	}
	...
	public static function setErr( $mes ) {
		...
		update_option( YAY_SMTP_SENDINBLUE_PREFIX . '_debug', array_unique( $result ) );
	}

	public static function getErr() {
		return (array) get_option( YAY_SMTP_SENDINBLUE_PREFIX . '_debug', array() );
	}
}
