...
class Plugin {
	...
	private function doHooks() {
		$optionVersion   = YAY_SMTP_SENDINBLUE_PREFIX . '_version';
		$current_version = get_option( $optionVersion );
		if ( version_compare( YAY_SMTP_SENDINBLUE_VERSION, $current_version, '>' ) ) {
			self::activate();
			update_option( $optionVersion, YAY_SMTP_SENDINBLUE_VERSION );
		}
