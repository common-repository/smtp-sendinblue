  ...
  <div class="yay-smtp-card-header">
	<div class="yay-smtp-card-title-wrapper">
	  <h3 class="yay-smtp-card-title yay-smtp-card-header-item">
		<?php echo esc_html__( 'Email Delivery Issue', 'smtp-sendinblue' ); ?>
	  </h3>
	</div>
  </div>
  <div class="yay-smtp-card-body">
	<p class="setting-description">
	  <?php echo esc_html__( 'YaySMTP noticed this error (yikes!) while trying to send the most recent emails:', 'smtp-sendinblue' ); ?>
	</p>
	...
	<p class="setting-description" style="font-weight: 450;">
	  <?php echo wp_kses_post( 'Please fix it and send a test email afterwards. <a href="https://yaycommerce.com/support/" target="_blank">Contact us</a> if you need any helps.', 'smtp-sendinblue' ); ?>
	</p>
  </div>
</div>
